#!/usr/bin/env python3
"""
Fetch Windows LockScreen image and post it to Bluesky
"""
import os
import sys
import random
...
def create_caption(images_data):
    ...
    header = "🔒 Windows LockScreen Images\n\n"
    ...
    hashtags = ['#WindowsLockScreen, ', '#LockScreen, ', '#Wallpaper, ', '#Microsoft, ', '#Photography' , '@sayed.page']
